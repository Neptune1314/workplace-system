        ...
        <div class="row">
            ...
            <div class="rounded border jobs-wrap">
                ...
                <div class="company-logo blank-logo text-center text-md-left pl-3">
                    ...
                    <img src="{{asset('upload/logo')}}/{{$job->company->logo}}" alt="Image" class="img-fluid mx-auto">
                    @else
                <img src="{{asset('upload/logo/company_defualt.png')}}" alt="Image" class="img-fluid mx-auto">
                    @endif
                </div>
